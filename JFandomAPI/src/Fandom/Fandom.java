...
public class Fandom {
	...
	public Fandom(String fandomUrl) {
		...
		try {
			...
			throw new RuntimeException("Something went wrong. The fandom-URL might be incorrect or the WikiMedia-API was updated (set static boolean Fandom.DEBUG to true to print exact stack trace)");
		}
		this.root = root;
		this.name = name;
		this.lang = lang;
	...
	/**
	 * Returns a {@link Fandom.FandomActivity} instance.
	 * @return
	 */
