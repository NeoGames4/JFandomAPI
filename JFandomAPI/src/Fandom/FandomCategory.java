...
public class FandomCategory extends FandomPage {
	...
	public FandomCategory(String title, Fandom fandom) {
		...
		try {
			...
			throw new ReadingException("Can't read category information (set static Fandom.DEBUG to true to print the exact exception stack trace)\n(This exception might occur if the page is not really a category page.)");
		}
	}
